...
export class DOM {
	...
	public static elPerformanceVideoPlayer1CV: HTMLElement;
	...
	public static elPerformanceVideoPlayer2CV: HTMLElement;
	...
	public static initialize(): void {
		...
		DOM.elPerformanceVideoPlayer1CV = <HTMLElement>document.getElementById('performance-video-player1-cv');
		...
		DOM.elPerformanceVideoPlayer2CV = <HTMLElement>document.getElementById('performance-video-player2-cv');
